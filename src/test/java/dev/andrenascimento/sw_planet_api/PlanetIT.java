package dev.andrenascimento.sw_planet_api;

import static dev.andrenascimento.sw_planet_api.common.PlanetConstants.ALDERAAN;
...
public class PlanetIT {
  ...
  public void listPlanets_ByClimate_ReturnsPlanets() {
    ResponseEntity<Planet[]> sut = restTemplate.getForEntity("/planets?climate=" + ALDERAAN.getClimate(),
        Planet[].class);
